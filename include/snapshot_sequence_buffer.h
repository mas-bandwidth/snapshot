...
#ifndef SNAPSHOT_SEQUENCE_BUFFER
#define SNAPSHOT_SEQUENCE_BUFFER
...
struct snapshot_sequence_buffer_t * snapshot_sequence_buffer_create( void * context, 
                                                                     int num_entries, 
                                                                     int entry_stride )
{
...
#endif // #if SNAPSHOT_SEQUENCE_BUFFER_H
